...
/**
 * Alla fem körs, inte bara vinnaren. `english` och `decompose` förlorade
 * (6/10 respektive 5/10) och används inte i produktion — men de är BEVISET
 * för varför `balanced` ser ut som den gör, och utan dem i sviten går den
 * jämförelsen inte att reproducera. Ta inte bort dem för att de är oanvända.
 */
const STRATEGIES = { raw, sentence, english, decompose, combined, balanced };
